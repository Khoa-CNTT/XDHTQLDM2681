...
<body class="bg-light">
            ...
            <div class="card-body">
                <form>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mt-2">
                            <img id="logoPreview" src="logo-placeholder.png" alt="Xem trước logo" class="img-thumbnail" style="max-width: 150px; display: none;">
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <button type="button" class="btn btn-link p-0 mt-2" data-bs-toggle="modal" data-bs-target="#editModal">Chỉnh sửa</button>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="productDescription" rows="4" placeholder="Nhập mô tả sản phẩm"></textarea>
                    </div>
    ...
    <script>
        ...
        document.getElementById('shopLogo').addEventListener('change', function (event) {
