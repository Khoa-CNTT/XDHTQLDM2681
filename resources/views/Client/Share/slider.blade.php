                            ...
                            <div class="row row-cols-lg-2 row-cols-md-2 row-cols-1 align-items-center">
                                ...
                                <div class="col">
                                    <div class="hero__slider--layer">
                                        <img class="slider__layer--img " src="image/banner/banner1.png" alt="slider-img">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row row-cols-lg-2 row-cols-md-2 row-cols-1 align-items-center">
                                ...
                                <div class="col">
                                    <div class="hero__slider--layer home1__slider--layer2">
                                        <img class="slider__layer--img  home1__slider--layer2__img" src="image/banner/banner2.png" alt="slider-img">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container slider__items--container">
                        <div class="hero__slider--items__inner">
                            <div class="row row-cols-lg-2 row-cols-md-2 row-cols-1 align-items-center">
                                ...
                                <div class="col">
                                    <div class="hero__slider--layer">
                                        <img class="slider__layer--img " src="image/banner/banner3.jpg" alt="slider-img">
                                    </div>
                                </div>
                            </div>
                        </div>
