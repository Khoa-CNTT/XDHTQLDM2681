            ...
            <div class="col-lg-8 col-md-10">
                <div class="card shadow rounded-4">
                    <div class="card-header bg-primary text-white">
                        <h4 class="mb-0">Thêm/Sửa Khuyến Mãi</h4>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ isset($offer) ? route('offers.update', $offer) : route('offers.store') }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control">
                                            <option value="1" {{ old('status', $offer->status ?? 1) == 1 ? 'selected' : '' }}>
                                                Hiện
                                            </option>
                                            <option value="0" {{ old('status', $offer->status ?? 0) == 0 ? 'selected' : '' }}>
                                                Ẩn
                                            </option>
                                        </select>
                                        @error('status')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="is_global" class="form-control">
                                            <option value="1" {{ old('is_global', $offer->is_global ?? 0) == 1 ? 'selected' : '' }}>
                                                Có
                                            </option>
                                            <option value="0" {{ old('is_global', $offer->is_global ?? 0) == 0 ? 'selected' : '' }}>
                                                Không
                                            </option>
                                        </select>
                                        @error('is_global')
                                            ...
                                            @foreach ($restaurants as $restaurant)
                                                <div class="form-check">
                                                    <input type="checkbox" name="restaurant_ids[]" value="{{ $restaurant->id }}"
                                                        class="form-check-input" id="restaurant_{{ $restaurant->id }}" {{ in_array($restaurant->id, old('restaurant_ids', $selectedRestaurants ?? [])) ? 'checked' : '' }}>
